 ...
 * implementations, and how to register custom actions.
 *
 * ## Actions API
 *
...
/**
 * Override default actions and register custom actions.
 *
...
export function setupActions(cesdk: CreativeEditorSDK): void {
  ...
  // Suppress unused variable warning (remove when uncommenting actions above)
  void cesdk;
}
